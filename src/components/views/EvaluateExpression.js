...
import EvaluateExpressionRenderer from './../EvaluateExpression';
...
class EvaluateExpression extends Component {

  jsonLayout = {
    "5ae8e8867144b3617da2626b": {
      "data": {
        "value": [
        ]
      },
  ...
  constructor(props){
    ...
    this.state = {
      ...
      nodeId: "5ae8e8867144b3617da2626b",
      elements: 0,
      columns: 1
    }
  }
